...
class Ui_Diary(object):
    def setupUi(self, Diary):
        ...
        self.widget_calendar = QCalendarWidget(self.centralwidget)
        self.widget_calendar.setObjectName(u"widget_calendar")
        self.widget_calendar.setMinimumSize(QSize(400, 400))
        self.widget_calendar.setMaximumSize(QSize(400, 400))
        self.widget_calendar.setLocale(QLocale(QLocale.English, QLocale.UnitedStates))
        self.widget_calendar.setSelectedDate(QDate(2024, 3, 8))
        self.widget_calendar.setFirstDayOfWeek(Qt.Sunday)
        self.widget_calendar.setGridVisible(False)
        self.widget_calendar.setSelectionMode(QCalendarWidget.SingleSelection)
        self.widget_calendar.setHorizontalHeaderFormat(QCalendarWidget.ShortDayNames)
        self.widget_calendar.setVerticalHeaderFormat(QCalendarWidget.NoVerticalHeader)
        self.widget_calendar.setNavigationBarVisible(True)
        self.widget_calendar.setDateEditAcceptDelay(200)

        self.verticalLayout.addWidget(self.widget_calendar)
